...
> ca va étre une boucle infinie sans conditions d'arret
...
> le mot-clé break sert a sortir d'une boucle 
...
> le mot-clé continue permet de passer a la prochaine iteration d'une boucle directement
...
> la variable initializer est utiliser en premier pour tester la conditions pour voir si les instructions vont etre executée si vrai les instructions son executée est la phase de l'incrementation arrivent pour passer a la prochaine itération
...
> oui , la variable utilisé sur la partie d'initialization de la variable de la boucle peut etre declarer et initializer avant l'utilisation de la boucle
...
> À mon avis c le temps d'execution et la complexité calculé et la consommation des resources cpu et memory et stockage
...
> Oui , vue les conditions qui controle l'iteration de la boucle non rien a voir avec les conditions qui controle le switch
