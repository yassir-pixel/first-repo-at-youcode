...
let entreprise = {
    nom: "",
    employes: [
        {nom: "Erin", prenom: "Phill", ville: "Casablanca", role: "SysAdmin"},
        {nom: "Sara", prenom: "Marco", ville: "Marrakesh", role: "NetworkAdmin"},
        {nom: "Eizo", prenom: "Auditore", ville: "Tanger", role: "Soc"},
        {nom: "Taousi", prenom: "Yassir", ville: "Nador", role: "DevOps"}
    ]
}
