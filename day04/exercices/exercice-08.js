...
function capitaliser(mot) {
    let transformer = mot.toLowerCase()
    console.log(transformer)
    return transformer.charAt(0).toUpperCase() + transformer.slice(1)
}

let motcTransformer = capitaliser("yOUcoDe")

console.log(motcTransformer)